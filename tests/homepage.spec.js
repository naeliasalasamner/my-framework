...
test.describe('homapage loads and has correct title', async ({ page }) => {
    const homePage = new HomePage(page)
    await homePage.goto('/');
    await expect(page).toHaveTitle(/naelia salas/);
});

test.describe('clicking About nav link scrolls to about section', async ({ page}) => {
    const homePage = new HomePage(page)
    await homePage.goto('/');
...
test.describe('clicking Projects nav link scrolls to projects section', async ({ page }) => {
    const homePage = new HomePage(page)
    await homePage.goto('/');
...
test.describe('clicking Contact nav link scrolls to projects section', async ({ page }) => {
    const homePage = new HomePage(page)
    await homePage.goto('/');
...
test.describe('CV download button is visible and correct download attribute', async ({ page }) => {
    const homePage = new HomePage(page)
    await page.goto('/');
...
test.describe('form shows error for invalid email', async ({ page }) => {
    const homePage = new HomePage(page)
    await homePage.goto('/');
